    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-5 border bg-slate-50 p-12 rounded-lg">
                <div className="flex justify-between items-center cursor-pointer" onClick={()=>setSobre(!sobre)}>
                ...
                <div className={`${!sobre && 'hidden'} flex flex-col transition-all translate-x-7`}>
                    123456789
                </div>
            </div>
            <div className="flex flex-col gap-5 border bg-slate-50 p-12 rounded-lg">
                <div className="flex justify-between items-center cursor-pointer" onClick={()=>setEndereco(!endereco)}>
                    <div className="flex gap-2">
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 512 512">
                ...
                <div className={`${!endereco && 'hidden'} flex flex-col transition-all translate-x-7`}>
                    123456789
                </div>
            </div>
            <div className="flex flex-col gap-5 border bg-slate-50 p-12 rounded-lg">
                <div className="flex justify-between items-center cursor-pointer"  onClick={()=>setContato(!contato)}>
                    <div className="flex gap-2">
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 512 512">
                ...
                <div className={`${!contato && 'hidden'} flex flex-col transition-all translate-x-7`}>
                    123456789
                </div>
            </div>
        </div>
