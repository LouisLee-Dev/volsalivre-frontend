...
const RegisterStudent: React.FC<RegisterStudentProps> = ({title}) => {
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            {page === '1' && <ConfirmDaBolsaChildren title={title} data={data} setPage={setPage} setData={setData} />}
            {page === '2' && <IdentificacaoChildren title={title} data={data} setPage={setPage} setData={setData} />}
            {page === '3' && <PagamentoChildren title={title} data={data} setPage={setPage} setData={setData} />}
