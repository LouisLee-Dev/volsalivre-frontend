      ...
      <div className="flex flex-col items-center relative">
        ...
        <div className="absolute flex flex-col justify-center bottom-0 lg:w-2/3 mx-5 w-lvw">
          ...
          <div className="tag-container overflow-auto inline-flex gap-5 bg-white justify-around p-5 rounded-tr-lg">
            ...
            >
              <div className={`bg-purple-700 group-hover:bg-purple-800 focus:outline-none ${ filters && levels && filters?.level === levels[0]._id && 'ring-4 ring-purple-300' } rounded-full p-2`}>
                <svg
                  aria-hidden="true"
              ...
              <span className={`bg-purple-700 group-hover:bg-purple-800 focus:outline-none py-1 pl-2 pr-3 rounded-r-lg text-nowrap`}>
                Ensino básico
              </span>
            </button>
            <button
              ...
              className="inline-flex -space-x-2 group text-sm text-white lg:text-base font-medium items-center text-center"
              >
              <div className={`${ filters && filters?.level === levels[1]._id && 'ring-4 ring-purple-300' } bg-purple-700 group-hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 rounded-full p-2`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2.5em"
                  height="2.5em"
            ...
            <button
              ...
              className="inline-flex -space-x-2 group text-sm text-white lg:text-base font-medium items-center text-center"
            >
              <div className={`${ filters && filters?.level === levels[2]._id && 'ring-4 ring-purple-300' } bg-purple-700 group-hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 rounded-full p-2`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2.5em"
                  height="2.5em"
